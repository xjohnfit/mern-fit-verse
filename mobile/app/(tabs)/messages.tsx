            ...
            <View style={styles.container}>
              ...
              <View style={styles.featureCard}>
                ...
                <Text style={styles.description}>
                  Direct messaging is being crafted with care for an amazing mobile experience.
                </Text>
                ...
                <View>
                  ...
                  <View style={styles.featureItem}>
                    ...
                    <Text style={styles.featureText}>Share workouts & progress</Text>
                  </View>
                  <View style={styles.featureItem}>
                    <View style={styles.checkIcon}>
                      <Ionicons name="checkmark" size={16} color="#10b981" />
                    </View>
                    <Text style={styles.featureText}>Connect with fitness friends</Text>
                  </View>
                </View>
              </View>

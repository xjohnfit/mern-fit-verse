          ...
          >
            <View style={styles.container}>
              ...
              <View style={styles.iconContainer}>
                ...
                >
                  <Ionicons name="nutrition" size={80} color="#10b981" />
              ...
              <View style={styles.featureCard}>
                ...
                <Text style={styles.description}>
                  Nutrition tracking is being crafted with care for an amazing mobile experience.
                </Text>
                ...
                <View>
                  <View style={styles.featureItem}>
                    ...
                    <Text style={styles.featureText}>Track meals & calories</Text>
                  </View>
                  <View style={styles.featureItem}>
                    <View style={styles.checkIcon}>
                      <Ionicons name="checkmark" size={16} color="#10b981" />
                    </View>
                    <Text style={styles.featureText}>Macro & micronutrient insights</Text>
                  </View>
                  <View style={styles.featureItem}>
                    <View style={styles.checkIcon}>
                      <Ionicons name="checkmark" size={16} color="#10b981" />
                    </View>
                    <Text style={styles.featureText}>Food database integration</Text>
                  </View>
                </View>
              </View>

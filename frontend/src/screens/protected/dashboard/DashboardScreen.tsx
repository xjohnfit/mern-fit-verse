...
const DashboardScreen = () => {
  ...
  const OverviewTab = () => (
    <div className="space-y-6">
      {/* Welcome Header with Wobble Cards */}
      <div className="mb-8">
      ...
      {/* Quick Action Wobble Cards */}
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
        <div onClick={() => navigate("/workout")} className="cursor-pointer">
          <WobbleCard
      ...
      {hasNutritionData && (
        <WobbleCard
          containerClassName="col-span-1 bg-linear-to-br from-indigo-600 to-purple-600 mb-6"
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-4 sm:p-6">
        <h3 className="text-lg sm:text-xl font-bold text-gray-900 dark:text-white mb-4">Community Feed</h3>
        <PostsFeed
          posts={feedPosts}
  ...
  const StatsTab = () => (
    <div className="space-y-6">
      <h2 className="text-xl sm:text-2xl font-bold text-gray-900 dark:text-white mb-6">Your Statistics</h2>

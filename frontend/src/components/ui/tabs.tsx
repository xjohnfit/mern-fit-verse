...
export const Tabs = ({
  ...
  return (
    <>
      <div
        className={cn(
          "flex flex-row items-center justify-center gap-1 sm:gap-2 perspective-[1000px] relative overflow-auto sm:overflow-visible no-visible-scrollbar max-w-full w-full",
          containerClassName
        )}
      >
